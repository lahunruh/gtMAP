...
#include "stanExports_GT_bayesian_logsumexp_optim.h"

RCPP_MODULE(stan_fit4GT_bayesian_logsumexp_optim_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_GT_bayesian_logsumexp_optim")
